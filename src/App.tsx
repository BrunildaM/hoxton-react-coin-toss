...
function App() {
  ...
  let eagle = (
    <img
      src="https://i.colnect.net/f/5450/348/10-Qindarka-10-Qindar-Leku.jpg"
      alt=""
      width={150}
    />
  );
  let lion = (
    <img
      src="https://i.pinimg.com/236x/53/c0/96/53c09607cf6fa7c439a22cbd13d154f1--rare-coins-albania.jpg"
      alt=""
      width={150}
    />
  );
